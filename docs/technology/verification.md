...
| A — FCC result | registered extension result verified on Coston2 | REGISTERED SENDER + LOCAL TYPED HANDLER/GOLDEN VECTOR PASS + PRODUCTION ADMISSION PREFLIGHT IMPLEMENTED/LOCALLY TESTED / PRODUCTION MACHINE + LIVE RESULT NOT VERIFIED |
