...
| Policy registry, vault, router, and foundation sender contracts | `NEW` | `packages/contracts/` | `2443d9d`, `607113e`, `1cfe44b`, `17ff0bc`, `67f21bb` | Foundry unit/fuzz/invariant/security tests, generated binding drift, Coston2 runtime/constructor/wiring verification. No external audit or verified full release exists. |
...
| Deployment, recovery, security, release, and public-evidence tooling | `NEW` with official protocol dependencies | `tooling/`, `releases/`, `.github/` | `fc2069e`, `f1a1d85`, `17ff0bc`, `7927fdd`, `4e589a0` | Pinned toolchain, guarded broadcast, runtime/wiring reads, restart journals, secret/privacy/evidence scans, release rejection, public historical funding reconstruction. Live writers require explicit local credentials and do not emit them. |
