...
| Policy registry, vault, router, foundation sender, and atomic XRPL FDC consumer contracts | `NEW` | `packages/contracts/` | `2443d9d`, `607113e`, `1cfe44b`, `17ff0bc`, `67f21bb`, `4bc6cd8` | Foundry unit/fuzz/invariant/security tests, generated binding drift, Coston2 runtime/constructor/wiring verification, official FDC selector and cross-language input-commitment vector. One live proof consumption reaches only `Pending` under simulated policy custody; private FDC evaluation passes locally, while live FCC evaluation, external audit, and a full release remain open. |
