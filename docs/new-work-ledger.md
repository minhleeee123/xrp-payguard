...
| Stateless threshold relay/executor core | `NEW` | `apps/relay/` | `916f140`, `1a8c6f0`, `4101e56`, `987db37`, `a6788a0`, `546c641`, `dbd5f9a`, `85e8fa9` | Threshold/domain/replay/split/outage, idempotency, rate limit, public recovery, competing executor, health, aggregate-private observability, and a hosted authenticated V2 Coston2 candidate path. The deployed route accepts the exact on-chain policy-owner evaluation signature with owner/IP budgets while keeping the relay as a bounded gas-paying executor; an independently funded owner lifecycle and negative authorization matrix passed on Coston2. |
