...
| Web application and landing | `NEW` implementation from the adapted visual direction | `apps/web/`, `DESIGN.md` | `81f4797`, `8383d18`, `d597036`, `6cc99c2`, `5e15726`, `914a7bb` | Unit/type/build, desktop/mobile/keyboard/reduced-motion smoke, reviewed evidence decoding, Lighthouse, no browser persistence, Vercel asset reachability, and hosted V1 FCC custody/evaluation controls. The live path is explicitly `SIMULATED_TEE`, operator-only, and not a verified release. |
