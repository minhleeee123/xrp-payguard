...
export const APP_VIEWS = ["studio", "vaults", "requests", "demo", "payment"] as const;
...
export function parseAppRoute(hash: string): AppRoute {
  ...
  if (normalized.startsWith("#app/")) {
    ...
    if (candidate === "team" || candidate === "payee" || candidate === "auditor") return { surface: "app", view: "payment" };
