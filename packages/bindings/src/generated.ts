...
export const PayGuardFccDispatcherAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "inputs": [
      {
        "name": "request",
        "type": "tuple",
        "internalType": "struct PayGuardFccDispatcher.FoundationRequest",
        "components": [
          {
            "name": "schemaVersion",
            "type": "uint16",
